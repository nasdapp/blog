...
var env = localStorage.getItem("chain") || "mainnet"

var chainConfig = ({
    mainnet: {
        name: "主网",
        contractAddress: "n1sdL5snz7uUdoPi5vXMBRDXriysjpkRZUX",
        host: "https://mainnet.nebulas.io",
        payhost: "https://pay.nebulas.io/api/mainnet/pay"
    },
    testnet: {
        name: "测试网",
        contractAddress: "n1mg1jS2aVKBWZ5hFEyiqB7Znz3nXbqqugo",
        host: "https://testnet.nebulas.io",
        payhost: "https://pay.nebulas.io/api/pay"
    }
})[env];

const dappAddress = chainConfig.contractAddress;
const Account = nebulas.Account;
const neb = new nebulas.Neb();
const nasApi = neb.api;
neb.setRequest(new nebulas.HttpRequest(chainConfig.host));
